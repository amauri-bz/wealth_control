...
class Acoes extends base.Base {
  constructor() {
    ...
    let add_acoes = document.getElementById("add_acoes");
    add_acoes.addEventListener("click", super.add_entry, false);

    let clear_acoes = document.getElementById("clear_acoes");
    clear_acoes.addEventListener("click", super.edit_clear, false);
  }
