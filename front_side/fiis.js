...
class Fiis extends base.Base {
  constructor() {
    ...
    let add_fiis = document.getElementById("add_fiis");
    add_fiis.addEventListener("click", super.add_entry, false);

    let clear_fiis = document.getElementById("clear_fiis");
    clear_fiis.addEventListener("click", super.edit_clear, false);
  }
