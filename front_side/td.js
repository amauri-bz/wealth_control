...
class TD extends base.Base {
  constructor() {
    ...
    this.charts = [
      {
        name: "pie_chart_td",
        chart: new Chart(
          document.getElementById("pie_chart_td").getContext("2d"),
          {
            type: "pie",
    ...
    let add_td = document.getElementById("add_td");
    add_td.addEventListener("click", super.add_entry, false);

    let clear_td = document.getElementById("clear_td");
    clear_td.addEventListener("click", super.edit_clear, false);
  }
